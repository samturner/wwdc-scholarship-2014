...
- (void) populateProjects {
    ...
    muro.projectDescription = [NSString stringWithFormat:@"%@\r\r%@\r\r%@\r\r%@", @"Muro is the name of a company that I started with two friends from University. We where fortunate enough to be accepted into an incubator at Sydney University where we recieved seed funding and working space. We had to validate our idea, figure out how to monetise (which was extremely difficult), meet with users and investors and obviously, build the product.", @"Muro was platform for people at events to interact and meet new people. We also worked with event organisers to provide them with in depth statistics about demographics for their events.", @"I worked as a designer and web developer, working closely with our iOS developer. This provided me the opportunity to use my skills to build something people love. I also learned how to pitch to investors and work with customers.", @"Muro is still on the app store today and we have over a thousand registered users. Unfortunately, we don't actively develop it anymore. Nevertheless, it was an amazing experience and I learnt so much about building things people love to use and how important it is to involve end users in the development process."];
    muro.leads = [[NSArray alloc] initWithObjects:@"Accepted in Sydney University's INCUBATE and received seed funding.", @"Worked in partnerships with some of the biggest events in Sydney.", @"Learned how difficult it is to build something people love.", nil];
