...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setProgressTintColor:[UIColor colorWithRed:0.37 green:0.91 blue:0.34 alpha:0.7]];
        [circularProgressViewAppearance setBackgroundColor:[UIColor clearColor]];
        [circularProgressViewAppearance setThicknessRatio:0.03f];
